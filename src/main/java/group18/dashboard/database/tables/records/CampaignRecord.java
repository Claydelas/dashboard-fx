...
public class CampaignRecord extends UpdatableRecordImpl<CampaignRecord> implements Record15<Integer, String, LocalDateTime, LocalDateTime, Integer, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double, Double> {

    private static final long serialVersionUID = 1887076589;
    ...
    @Override
    public Row15<Integer, String, LocalDateTime, LocalDateTime, Integer, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double, Double> valuesRow() {
    ...
    @Override
    public CampaignRecord values(Integer value1, String value2, LocalDateTime value3, LocalDateTime value4, Integer value5, Integer value6, Integer value7, Integer value8, Integer value9, Double value10, Double value11, Double value12, Double value13, Double value14, Double value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CampaignRecord(Integer cid, String name, LocalDateTime startDate, LocalDateTime endDate, Integer impressions, Integer clicks, Integer interactions, Integer bounces, Integer conversions, Double ctr, Double cpa, Double cpc, Double cpm, Double bounceRate, Double totalCost) {
        super(Campaign.CAMPAIGN);
