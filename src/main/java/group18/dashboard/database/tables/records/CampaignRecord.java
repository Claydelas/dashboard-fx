...
public class CampaignRecord extends UpdatableRecordImpl<CampaignRecord> implements Record19<Integer, Integer, String, Integer, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double, Double, Boolean, Integer, Boolean, Double, Boolean> {

    private static final long serialVersionUID = 655185310;
    ...
    @Override
    public Row19<Integer, Integer, String, Integer, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double, Double, Boolean, Integer, Boolean, Double, Boolean> valuesRow() {
    ...
    @Override
    public CampaignRecord value18(Double value) {
        setMinTime(value);
        return this;
    }
     ...
     */
    public CampaignRecord(Integer cid, Integer uid, String name, Integer impressions, Integer clicks, Integer uniques, Integer bounces, Integer conversions, Double ctr, Double cpa, Double cpc, Double cpm, Double bounceRate, Double totalCost, Boolean minPagesEnabled, Integer minPages, Boolean minTimeEnabled, Double minTime, Boolean parsed) {
        super(Campaign.CAMPAIGN);
